...
def main():
    ...
    # Accept only the file name now.
    parser.add_argument("--input_file", type=str, default="1.csv",
    ...
    # Join the test directory with the provided file name.
    # input_path = os.path.join(TESTS_DIRECTORY, args.input_file)
